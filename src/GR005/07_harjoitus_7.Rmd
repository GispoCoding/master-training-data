...
Käynnistä QGIS-ohjelmisto. Avaa harjoituksen 6 QGIS-projektisi ja tallenna se nimellä (**Projekti → Tallenna nimellä...**) "**QGIS_harjoitus_7**".

Lisää aineistoosi sopiva taustakartta. Esimerkiksi Kuopion WMS-palvelusta Kantakartta

![](img/harjoitus_7/image1_1.png)
...
-   Kartan mittakaavaksi jokin hyvä tasaluku esimerkiksi 1:20 000
...
QGIS mahdollistaa myös kartta-atlaksen tekemisen. Kartta-atlas on ns. karttakirja, jonka avulla voidaan tuottaa automatisoidusti paljon karttoja samasta teemasta. Tavoitteenamme on tuottaa jokaisesta kaupunginosasta kartta.

Nyt projektissa on tasoina ainakin jv-johdot ja kaupunginosat. Voit myös lisätä muita haluamiasi tasoja projektiin. Avaa uusi tuloste ja aseta sen sommittelu haluamaasi kokoon (esimerkiksi A5).

Lisää tulosteelle kartta, johon piirtyvät karttaikkunassa näkyvät projektin tasot. Lisää otsikko, selite ja muut karttatulosteen graafiset tai kartografiset elementit (kuten logo tai pohjoisnuoli) totuttuun tapaan. Lähennä karttanäkymä n. yhden kaupunginosan laajuiseksi (esim. 1:20 000), sillä lopputuloksessa kartta-atlaksen karttalehdet automaattisesti kohdentuvat postinumeroalueiden kokoon.
...
Huomaa, kuinka yleiskarttanäkymän pieni vaaleanpunainen neliö vaihtaa paikkaa sitä mukaa kun kohdennetun kartan alue vaihtuu.
