...
Avaa projektiisi **jv_johdot.TAB** ja muunnetaan se harjoituksen aluksi GeoPackageksi. Tämä varmistaa sen, että saamme laskettua alueellisia summia ja tehtyä SQL-kyselyitä. Klikkaa Tasot-luettelossa jv-johdot tasoa hiiren oikealla ja valitse **Vie** \> **Tallenna kohteet nimellä.** Anna Tiedostomuodon olla GeoPackage. Valitse **Tiedostonimeksi** jv-johdot ja **Tason nimeksi** jv-johdot. Vaihda **koordinaattijärjestelmäksi** Ennalta määritelty koordinaattijärjestelmä ja valitse **ETR89/GK27FIN** (EPSG:3881). Tallenuksen jälkeen taso ilmestyy Tasot-paneeliin. Poista alkuperäinen jv-johdot.TAB painamalla tasoa hiiren oikealla ja valitsemalla **Poista taso**.

Tutkitaan seuraavaksi tasoa QGISin tilastot-paneelissa, jossa voit tarkastella aineistosi arvojen tilastollista jakaumaa.
