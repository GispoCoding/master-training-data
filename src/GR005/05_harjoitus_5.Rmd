...
GeoPackage on tietokanta, jossa tieto on tallennettu tauluihin. Anna tietokannan nimeksi **"Jätevesi"** ja luotavan tason nimeksi **"Viemäripiirit"**. Valitse taulun geometriaksi polygoni ja koordinaattijärjestelmäksi **3881**. Lisää GeoPackageen nyt muutama muu uusi sarake seuraavasti:
