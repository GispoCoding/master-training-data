...
Tavoite on, että kouluttautuja saa asennettua Mergin Maps -mobiilisovelluksen käyttövalmiiksi laitteelleen ja saa luotua käyttäjätunnukset pilviympäristöön.
...
Kirjaudu sisään samoilla tunnuksilla, jotka juuri loit pilviympäristöön.
