...
**Fields to add** kohdassa valitse listasta **i_huoneistojen_lkm**. Jos kenttä jää tyhjäksi niin kaikki Rakennus-tason sarakkeet lisätään. Tarkista vielä, että Join type on **Create separate feature for each matching feature (one-to-many)**, jotta jokainen piste huomiodaan uudessa tasossa.
