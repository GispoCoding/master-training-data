...
Joihinkin Widgetteihin voidaan lisätä ns. lapsiwidgettejä (child Widget), joka
mahdollistaa käyttöliittymän suunnittelun. Esimerkkinä tästä harjoituksessa
luotava **QDialog**- widgetti, johon lisätään muun tyyppisiä lapsiwidgettejä.
...
perii jonkin olemassa olevan widget- luokan. QGISisiin on luotu sille ominaisia
...
Label on teksikomponentti. Counter toimii siten, että kun sen painiketta
