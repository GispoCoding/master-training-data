...
Valitse pohjaksi pohjaksi **Dialog with Buttons Bottom** ja paina **Create**.
Seuraavaksi vaihda oikeasta yläkulmasta "Object Inspector"-valikosta
vaihda QDialog-olion nimeksi **BufferToolDialog** ja lopuksi muokkaa
...
kontrolloimaan eri painikkeita. Kaksoisklikkaaa OK-painike pois.
...
valikko lisäosalle. Tässä määritellään painikkeet, mitkä lisätään lisäosan
...
Järjestele komponentit esimerkiksi allekain ja lopuksi voi
määrittää koko BufferToolDialog-oliolle layoutin klikkaamalla hiiren oikealle
sen taustaa:
...
tuottavan ja testataan saatinko oikea tulos. Lisäksi voidaan
