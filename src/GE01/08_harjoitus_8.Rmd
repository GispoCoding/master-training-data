...
jossa on muutama hyöty. Tällöin algoritmeille määritetään
...
Jos halutaan kutsua toinen prosesointialgoritmi Pythonilla
...
ensin importoida, joka on tehty tiedoston alussa. Jos provideriin
...
* Jos valitun pisteen koordinaattijärjestelmä poikeeaa lähtötason
