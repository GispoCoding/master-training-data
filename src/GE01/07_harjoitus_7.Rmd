...
tällöin työkalu luo uuden pistetason kyseisellä koordinaattijärjestelmän.
...
näyttää virheen. Jos käyttäjä on valinnut pistetason koordinaattijärjestelmä-
widget inaktivoituu siten ja se ei vaikuta lisättävään pisteeseen mitenkään.
