...
|                                  |                                                         |
|:------------------:|:--------------------------------------------------:|
| ![](img/harjoitus_5/image5.png) |                Valitse/siirrä elementtiä                |
| ![](img/harjoitus_5/image6.png) | Siirrä elementin sisältöä (esimerkiksi kartan sisältöä) |
| ![](img/harjoitus_5/image7.png) |                 Zoomaa taiton näkymässä                 |

QGISin avulla voit muokata karttatulosteesi ulkoasua. Otsikko tai muu teksti voidaan lisätä **Lisää uusi nimiö** -työkalulla: ![](img/harjoitus_5/image8.png)

Lisää uusi selite käyttäen: ![](img/harjoitus_5/image9.png)

Ja lisää uusi mittakaava käyttäen: ![](img/harjoitus_5/image10.png)
...
Voit myös muokata selitteen ominaisuuksia. Huomaa, että sinun on poistettava kohdan **Päivitä automaattisesti** rasti. Pohjoisnuolen lisääminen tapahtuu lisäämällä kuva tällä työkalulla (vasemmasta palkista): ![](img/harjoitus_5/image12.png)
...
Varmista, että karttakomponentti on valittuna, valitse se **Valitse/Siirrä elementti -työkalulla** vasemmasta työpalkista ja klikkaamalla kartta aktiiviseksi: ![](img/harjoitus_5/image5.png)
