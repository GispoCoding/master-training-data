...
Seuraavaksi laita **Tarttuminen** ![](img/harjoitus_2/image3.png), **Seuraaminen** ![](img/harjoitus_2/image4.png) **ja Self-snapping ![](img/harjoitus_2/image5.png)**päälle **Tarttumisen työkalut -paneelista**. Aseta muut tarttumisasetukset seuraavan kuvan mukaisiksi:
