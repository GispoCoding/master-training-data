...
Mene **Browse Layers**-valikkoon ja avaa **topp:states**-aineiston esikatselu painamalla **OpenLayers**-linkkiä:

![](img/harjoitus_13/image1.png)

Saat karttaikkunan vasemmalla puolella olevat valikot näkyviin, kun klikkaat kartan vasemmassa ylänurkassa olevaa nappulaa.
...
GeoServerin [dokumentaatiosta](https://docs.geoserver.org/main/en/user/tutorials/cql/cql_tutorial/#simple-comparisons) löytyy tarkempia kuvauksia.
