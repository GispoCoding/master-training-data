# Exercise 4: Qt-käyttöliittymät

**Contents:** PyQt:n perusteet.

**Goal:** Ymmärtää Qt-kirjaston toiminnan perusteet ja luoda yksinkertaisia graafisia käyttöliittymiä.
