...
vertexes. It does not contain infromation about the
...
Add two fieldsm named "fid" and "area". Add a feature with the
geometry that is included below. Calculate the area of geometry
and add the result the the "area" field". Finally add the new
...
The fields of the new layer should include a identifier
