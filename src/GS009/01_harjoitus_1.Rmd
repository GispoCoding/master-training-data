...
Käynnistä pgAdmin 4 -ohjelmisto menemällä osoitteeseen, minkä kouluttaja on antanut. Jokaisella kurssiosallistujalla on henkilökohtainen harjoitusympäristö mihin kuuluu pääsy pgAdminin selainohjelmistoon. Alla olevassa esimerkissä on eri numero kuin omassa osoitteessasi.

:::{.note-box}
https://postgresql-ja-postgis-perusteet-999.gispocoding.fi/pgadmin
:::

Pääset kirjautumaan etäpalvelimen pgAdminiin
seuraavilla tunnuksilla:

- Sähköpostiosoite: **student@gispocoding.fi**
- Salasana: **gispotraining**
...
-lisäosan) lisäksi myös psql-komentorivin kautta. Avaa selaimessa uusi välilehti. Ota sama etuosa pgAdmin-osoitteestasi mutta laita siihen sen sijaan **/wetty**, jotta pääset käyttämään
psql-komentorivityökalua. Alla olevassa esimerkissä on eri numero kuin omassa osoitteessasi.

:::{.note-box}
https://postgresql-ja-postgis-perusteet-999.gispocoding.fi/wetty
:::

Kirjaudu ensin sisään WeTTY- terminaaliemulaattoriin:

- Kirjoita käyttäjänimi **student** ja paina Enter
- Kirjoita salasana **gispotraining** ja paina Enter
