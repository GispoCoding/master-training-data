...
Harjoituksen jälkeen osallistuja osaa hyödyntää monipuolisemmin editoinnin ominaisuuksia.
...
Tässä harjoituksessa teemme rakennuksia rakennuspaikoille. Luo **Aluesuunnitelma-GeoPackageen** uusi taso rakennuksia varten seuraavasti:
...
8.  Valitse Digitoinnin lisätyökalujen palkista **"Tee yhdensuuntaissiirtymä"** -työkalu (Offset curve) ![](img/harjoitus_2/offset_curve.png).
...
![](img/harjoitus_2/Polygonin_kopiointi_koon_muuttaminen.gif)
...
## Lisätehtävä: Lisää Rakennukset tasolle funktio, jolla pohjanalatieto (yhden kerroksen pinta-ala) päivittyy automaattisesti
...
5.  Jos haluat vielä pyöristää arvoa niin, ettei kaikki desimaalit näy niin käytä round-funktiota. Jos esimerkiksi haluat pyöristää pohjanalan kahden desimaalin tarkkuudella, lauseke on `round($area,2)`

6.  **Lopuksi muista laittaa täppä kohtaan "Käytä oletusarvoa päivityksessä"**, jolloin QGIS laskee uudelle polygonille automaattisesti pohjanalan! 🎉
