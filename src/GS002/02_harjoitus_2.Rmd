...
-   Varmista, että laajennettu digitointi ![](img/harjoitus_2/image15.png)![]() on päällä.

-   Piirrä piste kartalle haluamaasi kohtaan. Laajennetun digitoinnin valikossa aktivoituvat kohtisuoruustyökalu ![](img/harjoitus_2/image18.png) ja yhdensuuntaisuustyökalu ![](img/harjoitus_2/yhdensuuntaisuus_tyokalu.png).
...
3.  Laita **editointi** päälle ![](img/harjoitus_2/toggle_editing.png) **Rakennukset**- tasolle,  **monikulmiokohteen piirtäminen päälle** ![](img/harjoitus_2/monikulmio_kohde.png) sekä l**aajennetun digitoinnin työkalut** aktiivisiksi ![](img/harjoitus_2/image15.png){width="26" height="24"}.
