...
![](img/harjoitus_7/image2.png) ![](img/harjoitus_7/image3.png)
...
Tässä ikkunassa voit myös muokata attribuuttitaulun perusrakennetta. Laita muokkaustila päälle lyijykynä-symbolista ja lisää attribuuttitauluun uusi kenttä ![](img/harjoitus_7/image6.png) . Anna kentälle nimeksi "**Alueyyppi**" ja määrittele se **tekstikentäksi** kuvan mukaisesti.
...
![](img/harjoitus_7/image12.png){width="373"}
...
Seuraavaksi aloitamme aineiston muokkaamisen klikkaamalla **Tason muokkaus päälle/pois** -työkalua ![](img/harjoitus_7/image14.png). Huomaat, että **Digitointi**-työkalupalkin muutkin työkalut aktivoituvat.

![](img/harjoitus_7/image15.png)

Valitse työkaluksi **Lisää kohde** ![](img/harjoitus_7/image16.png) ja aloita digitointi. Hiiren vasemmalla näppäimellä voit klikata kartalla kohteen kulmapisteet. Kun polygoni on valmis, napauta hiiren oikeaa näppäintä, jolloin QGIS luo uuden polygonin. Digitoi esimerkiksi peltoalue:
...
Digitoi muutama alue ja muista tallentaa digitoinnin tulokset aina välillä **Nykyiset muokkaukset -työkalun** ![](img/harjoitus_7/image24.png) avulla.
