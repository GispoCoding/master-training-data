---
title: "Johdanto QGISin käyttöön Porvoon kaupungille"
author: "Gispo Suomi Oy."
date: "`r Sys.Date()`"
site: "bookdown::bookdown_site"
abstract: "Räätälöity kurssi Porvoon kaupungille QGISin käytöstä"
output:
    bookdown::html_book:
        toc: true
        theme: null
...
Nämä materiaalit on "Johdanto QGISin käyttöön Porvoon kaupungille"- kurssille kehittänyt Gispo Suomi Oy. Materiaalit on lisensoitu seuraavalla lisenssillä: [CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0/)
