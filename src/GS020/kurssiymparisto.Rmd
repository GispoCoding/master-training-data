...
tallennettu, voit siirtyä sinne seuraavalla komennolla (vaihda polku sinulle sopivaksi):

::: commandline-box
```sh
cd C:\user\gispolainen\python-gis-training
```
:::

*Jos* `dir`-komento näyttää, että hakemiston sisällä on vielä yksi
`python-gis-training`-niminen hakemisto, siirry vielä sinne:

::: commandline-box
```sh
cd python-gis-training
```
:::

::: hint-box
Psst! Jos tarvitset liikkua ylöspäin kansiorakenteessa niin käytä 
