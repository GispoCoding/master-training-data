...
Rakentamistila aktivoidaan *Digitoinnin lisätyökalut-paneelista* löytyvästä ![](img/harjoitus_7/image17.png)![]()-nappulasta. Sen saa päälle/pois päältä myös pikakomennolla **C**. Digitoinnin lisätyökalut-paneelin saa tarvittaessa auki klikkaamalla hiiren oikealla QGIS-projektissa työkalujen valintanauhasta tyhjää kohtaa ja rastittamalla Paneelit --> Digitoinnin lisätyökalut -paneeli.
...
2.  Laita **editointi** päälle ![](img/harjoitus_7/toggle_editing.png) **Rakennukset**-tasolle,  **monikulmiokohteen piirtäminen päälle** ![](img/harjoitus_7/monikulmio_kohde.png) sekä **laajennetun digitoinnin työkalut** aktiivisiksi ![](img/harjoitus_7/image15.png).
