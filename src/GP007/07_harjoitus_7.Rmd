...
Rakentamistila aktivoidaan laajennetun digitoinnin paneelista löytyvästä ![](img/harjoitus_7/image17.png)![]()-nappulasta. Sen saa päälle/pois päältä myös pikakomennolla **C**.
...
Aseta **Rakennukset-tason** editointi päälle kynäkuvakkeesta. Kun valitset **Lisää polygonikohde -työkalun**, **Laajennettu digitointi -kuvake** aktivoituu ![](img/harjoitus_7/image15.png). Klikkaa kuvaketta niin saat **Laajennettu digitointi -hallintapaneeliin** QGISiin.
...
-   Varmista, että laajennettu digitointi ![](img/harjoitus_7/image15.png)![]() on päällä.

-   Piirrä piste kartalle haluamaasi kohtaan. Laajennetun digitoinnin valikossa aktivoituvat kohtisuoruustyökalu ![](img/harjoitus_7/image18.png) ja rinnakkainen-työkalu ![](img/harjoitus_7/yhdensuuntaisuus_tyokalu.png). Huom! Jos **tarttuminen** ei ole päällä, nämä työkalut eivät aktivoidu.
...
2.  Laita asteen mukaiset tukiviivat ja tarttuminen päälle laajennetun digitoinnin paneelista ![](img/harjoitus_7/snap_common_angles.png). Riittävä tarkkuus on tässä *"90, 180, 270, 360 astetta"*.
...
2.  Laita **editointi** päälle ![](img/harjoitus_7/toggle_editing.png){width="26" height="24"} **Rakennukset**-tasolle,  **monikulmiokohteen piirtäminen päälle** ![](img/harjoitus_7/monikulmio_kohde.png) sekä **laajennetun digitoinnin työkalut** aktiivisiksi ![](img/harjoitus_7/image15.png)![]().

3.  Laita **laajennetun digitoinnin** paneelista (vasen reuna) **rakentamistila** päälle ![](img/harjoitus_7/image19.png) (tai painamalla **C**).
