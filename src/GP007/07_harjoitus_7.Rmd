...
-   Varmista, että laajennettu digitointi ![](img/harjoitus_7/image15.png){width="26" height="25"} on päällä.

-   Piirrä piste kartalle haluamaasi kohtaan. Laajennetun digitoinnin valikossa aktivoituvat kohtisuoruustyökalu ![](img/harjoitus_7/image18.png) ja rinnakkainentyökalu ![](img/harjoitus_7/yhdensuuntaisuus_tyokalu.png).
...
2.  Laita **editointi** päälle ![](img/harjoitus_7/toggle_editing.png){width="26" height="24"} **Rakennukset**- tasolle,  **monikulmiokohteen piirtäminen päälle** ![](img/harjoitus_7/monikulmio_kohde.png) sekä **laajennetun digitoinnin työkalut** aktiivisiksi ![](img/harjoitus_7/image15.png){width="26" height="24"}.
