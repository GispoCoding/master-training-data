...
![](img/harjoitus_6/image2.png) ![](img/harjoitus_6/image3.png)
...
Tässä ikkunassa voit myös muokata attribuuttitaulun perusrakennetta. Laita muokkaustila päälle lyijykynä-symbolista ja lisää attribuuttitauluun uusi kenttä ![](img/harjoitus_6/image6.png) . Anna kentälle nimeksi "**Alueyyppi**" ja määrittele se **tekstikentäksi** kuvan mukaisesti.
...
![](img/harjoitus_6/image12.png){width="373"}
...
Seuraavaksi aloitamme aineiston muokkaamisen klikkaamalla **Tason muokkaus päälle/pois** -työkalua ![](img/harjoitus_6/image14.png). Huomaat, että **Digitointi**-työkalupalkin muutkin työkalut aktivoituvat.

![](img/harjoitus_6/image15.png)

Valitse työkaluksi **Lisää kohde** ![](img/harjoitus_6/image16.png) ja aloita digitointi. Hiiren vasemmalla näppäimellä voit klikata kartalla kohteen kulmapisteet. Kun polygoni on valmis, napauta hiiren oikeaa näppäintä, jolloin QGIS luo uuden polygonin. Digitoi esimerkiksi peltoalue:
...
![](img/harjoitus_6/image21.png) ![](img/harjoitus_6/image22.png)

Digitoi muutama alue ja muista tallentaa digitoinnin tulokset aina välillä **Nykyiset muokkaukset -työkalun** ![](img/harjoitus_6/image23.png) avulla.

![](img/harjoitus_6/image24.png)
