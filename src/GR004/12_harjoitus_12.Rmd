...
Koulutettava oppii georeferoimaan aineistoja joilla ei ole koordinaattijärjestelmätietoa

## Valmistautuminen

allenna QGIS-projekti nimellä (**Projekti → Tallenna nimellä…**) “**QGIS_harjoitus_georeferointi**”.
...
Kun valitset pisteen niin uusi ikkuna aukeaa. Valitse tämän jälkeen **Karttaikkunata** ja valitse mahdollisimman sama sijainti ortokuvalla. Tämän jälkeen Georeferoijan ikkunassa koordinaattitiedot päivittyvät. Paina tämän jälkeen **OK**.
