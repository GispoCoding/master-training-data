...
Tässä harjoitukksessa teemme rakennuksia rakennuspaikoille. Luo **Alueet-GeoPackageen** uusi taso rakennuksia varten seuraavasti:
...
1.  Laita tarttumisen työkalu (työtilan yläosassa) päälle **self-snapping** ![](img/harjoitus_7/image5.png).
...
6.  **Lopuksi muista laittaa täppä kohtaan "Käytä oletusarvoa päivityksessä"**, niin QGIS laskee uudelle polygonille automaattisesti pinta-alan! 🎉
    ...
    ![](img/harjoitus_7/image34.png)![](img/harjoitus_7/image35.png){width="519"}
