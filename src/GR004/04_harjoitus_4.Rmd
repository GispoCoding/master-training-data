...
Tässä näkymässä näet valmiita tyylejä. Alhaalla keskellä on vihreä plus-symbolia. Sillä voi luoda uusia tyylejä. Kokeile luoda esimerkiksi pisteille uuden visualisoinnin. Voit tämän jälkeen tallentaa visualisoinnin "oletuksena" tai ainoastaan tähän projektiin. Jos aiot käyttää samaa visualiointia muualla niin tallenna se oletuksena. Visualisointiin voi myös lisätä tägejä, jotka helpottavat visualisoinnin löytämistä.

Tyylit jotka tallennat tyylien hallinta-ikkunassa tulevat myös esiin kun olet asettamassa tyylejä tasoille. On myös mahodllista viedä omat tyylit ulos QGISistä XML-muodossa ja tuoda jonkun toisen tekemiä tyylejä. Tämä tapahtuu **Tuo/Vie**-napin kautta. 
