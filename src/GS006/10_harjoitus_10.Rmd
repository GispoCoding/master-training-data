# HARJOITUS 10: ARKKITEHTUURI JA KÄYTTÖÖNOTTO
...
GeoServerin **Monitor**-lisäosa on valmiiksi asennettu koulutuspalvelimiin, ja se näkyy päävalikosta alapuolelta. Tällä lisäosalla voidaan tarkastella GeoServerin liikennettä. Voit vapaasti tarkastella mitä Monitor-lisäosalla voi tehdä. Pohdi myös miten se voisi olla hyödyllinen teidän organisaatiossa.
