...
**Harjoituksen sisältö:** PyQGIS käytön perusteet
...
Avaa QGISiin `NaturalEarth_10m_admin_0_countries.gpkg`-tiedosto, jonka voit ladata [täältä](https://drive.google.com/file/d/108HNoFE-I10KEmsApBdtGQb9OdbL0FEF/view?usp=sharing).
...
Haetaan vektoritason kohteiden määrä käyttämäällä `featureCount()`:
...
ominaisuustieto käyttäen for-looppia:
...
Selvitä (PyQGISillä) **OpenStreetMap**-tason datan lähde.
