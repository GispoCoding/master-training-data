# 3. QGISin Python-konsoli

**Harjoituksen sisältö:** QGISin Python-konsoli ja skriptieditori.

**Harjoituksen tavoite:** Tutustua Python-komentojen ajamiseen konsolissa.
...
Windowsilla QGIS-asennukseen sisältyy erillinen Python-tulkki, jonka version voit tarkistaa valikosta **Ohje** -> **Tietoja QGISista**.
![](img/harjoitus_3/image_1.png)
...
::: hint-box
Jos Python-kieli ei ole tuttua niin voit siirtyä seuraavaan osioon. Siellä selviää miten harjoitus ratkaistaan.
:::
