...
Avaa **Valitse käyttäen lauseketta**-työkalua QGISissä (englanniksi Select by Expression). Valitse kaikki liikuntakohteet, jotka sijaitsevat kotikuntasi alueella ja jotka kiinnostaavat sinua. Tallenna valitut kohteet uudeksi erilliseksi karttatasoksi.
