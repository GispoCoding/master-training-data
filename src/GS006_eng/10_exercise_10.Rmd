...
GeoServer's **Monitor** plugin is pre-installed on the training servers and can be seen in the main menu below. This plugin allows you to view GeoServer traffic. Feel free to view what can be done with the Monitor plugin. Also consider how it could be useful in your organization. 
