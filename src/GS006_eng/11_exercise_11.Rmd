...
Press **Save**. From the **Styles** menu, open the style you just created and select the **Layer Preview** tab. Select a road layer as the layer to preview.
...
Press **Save** and visualize the result: ![](img/harjoitus_11/image5.2.png)
