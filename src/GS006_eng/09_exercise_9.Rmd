...
Finally, press **Save** to save the settings.
...
Press **Save** and return to **Tile Caching → Tile Layers** view.
...
If there is time, you can continue from here by doing additional tasks.
...
|                                                                                                                                            |                         |
|--------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| **Interface standard**                                                                                                                     | OGC's WMTS standard \| |
