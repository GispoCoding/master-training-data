...
The **sidebar (4)** on the right side shows the map services and their versions supported by the server in the home screen. This section is in the middle of the page in the newer version of the GeoServer.
...
Press **GeoServer-logo** to return to the main server page. 
...
This section is only visible on the home page. Remember that you can always access the home page by pressing the GeoServer logo.
