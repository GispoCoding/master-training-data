...
Luo uusi QGIS-projekti ja tallenna se nimellä (**Projekti → Tallenna nimellä…) “QGIS_harjoitus_10”**.
Lisää projektiin seuraavat tasot:

-   **…/Harjoitus 10/Vaestotietoruudukko_2022.gpkg**

-   **…/Harjoitus 10/L4133B.asc**
...
![](images/clipboard-3470209468.png)Voit tarkastella visualisointia esikatseluikkunassa tai exportoida sen html-tiedostoksi jolloin sen voi avata selaimella.
