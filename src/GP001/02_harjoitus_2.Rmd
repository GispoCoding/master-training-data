...
Harjoituksen jälkeen kouluttautuja tuntee paikkatietoaineistojen perusominaisuudet, osaa tarkastella vektoriaineiston geometriaa ja ominaisuustietoja QGISissä sekä valita ja suodattaa aineistoa.
...
## GeoPackagen avaaminen QGISissä
...
Tuodaan seuraavaksi paikkatietoaineisto QGISiin. Voit tarkastella Kurssihakemiston **Harjoitus 2- kansiota** QGISin **Selain-paneelissa** (löytyy ylhäältä vasemmalta tai, jos se ei ole näkyvillä, klikkaa yläpalkin harmaalla alueella hiiren oikeaa ja valitse Selain-paneeli).

![](images/clipboard-1430611042.png)

Lisää nyt **TieViiva.gpkg**-paikkatietoaineisto QGIS-projektiisi joko tuplaklikkaamalla aineistoa Selain-paneelissa tai valitsemalla **Avaa tietolähteiden hallinta** ![](img/harjoitus_2/image4.png). Sama toiminto löytyy myös QGISin ylävalikon kohdasta **Tasot \> Lisää taso \> Lisää vektoritaso...** . Valitse avautuvasta **Tietolähteiden hallinta -ikkunasta Vektori-välilehti** ja lisää **TieViiva-aineisto** kurssihakemistostasi **(../kurssihakemisto/ Harjoitus 2)**. Paina lopuksi **Lisää** ja sulje ikkuna.

![](img/harjoitus_2/image5.png){width="70%"}

## Shapefilen avaaminen QGISissä

Avataan seuraavaksi **Harjoitus 2- kansiosta postinumeroalueet_2025.shp** QGISiin. Tiedosto lisätään samalla tavalla kuin edellisessä kohdassa lisättiin GeoPackage. Katso esimerkkiä sieltä, jos et muista, miten aineisto lisättiin.

Tutki shapefileä ja geopackagea tiedostojen hallinnassa. Klikkaa hiiren oikealla shapefile-kansiota ja valitse Avaa hakemisto. Pohdi, mitä eroa on shapefilellä ja GeoPackagella.

![](images/clipboard-2422632424.png)
...
Kokeile työkalua **Valitse kohteet** ![](img/harjoitus_2/image15.png) . Klikkaa työkalu aktiiviseksi ja piirrä kartalle suorakaide. Kaikki Tieviiva-tason elementit, jotka osuvat edes osittain valintarajauksesi sisään, korostuvat keltaisella. Huom. poista Tasot-paneelista postinumerotason näkyvyys piirrossa.![](images/clipboard-2013683466.png)

![](img/harjoitus_2/image16.png)

Avaa nyt **tason attribuuttitaulu** joko ![](img/harjoitus_2/image17.png) -painikkeella tai klikkaamalla tasoluettelossa tasoa hiiren oikealla napilla ja valitsemalla **Avaa attribuuttitaulu**. Kaikki ne tie-elementit, jotka tulivat kartalta valituksi, ovat korostuneet taulussa sinisellä. Voit suodattaa attribuuttitaulun näkymää sen vasemmasta alanurkasta ja näyttää vain valitut kohteet:

![](img/harjoitus_2/image18.png)

Poista aineiston valinta klikkaamalla **Poista valinnat kaikilta tasoilta -painiketta** ![](img/harjoitus_2/image19.png) , joka löytyy attribuuttitaulun työkalupalkista.
...
Suodatusehtoina voit käyttää esim. suurempi kuin -, pienempi tai yhtä suuri kuin -, tai erisuuri kuin -operaattoreita. Voit myös yhdistellä eri kenttien ehtoja AND- ja OR-operaattoreilla. Muistutuksena siitä, että aineistoa on suodatettu, tasoluettelossa näkyy pieni suppilokuvake ![](img/harjoitus_2/image22.png) . Tätä kuvaketta klikkaamalla voit milloin tahansa palata suodatinlausekkeeseen, muokata sitä tai poistaa sen.
