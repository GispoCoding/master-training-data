...
Huomaa, että **"lennossa"-ilmaisulla** tarkoitetaan sitä, että paikkatietoaineisto piirtyy **tilapäisesti** projektin koordinaattijärjestelmään ilman, että sen alkuperäinen koordinaattijärjestelmä muuttuu. Tällä tavoin mahdollistetaan aineistojen piirtäminen ja visualisointi yhdessä. Avaa nyt päävalikosta **Projekti \> Ominaisuudet**... ja valitse vasemmasta palkista **Koordinaattijärjestelmä**. Pääset projektin koordinaattijärjestelmän asetuksiin myös klikkaamalla **QGIS-työtilan** oikeassa alareunassa olevaa **EPSG-painiketta** ![](img/harjoitus_4/image1.png) .
...
Koordinaattijärjestelmän muuttamisen jälkeen klikkaa **Zoomaa täydeksi** -työkalua ![](img/harjoitus_4/image5.png) , niin paikkatietoaineistot keskittyvät karttaikkunaan. Voit huomata, että paikkatietoaineistomme ovat nyt uudelleenprojisoituneet lennossa WGS 84 -koordinaattijärjestelmään ja samalla Suomi on vääristynyt muodoltaan.
...
![](images/clipboard-2476188776.png)QGISin **Tasot-paneeliin** ilmestyy uudelleenprojisoitu paikkatietoaineisto. Voit tarkistaa koordinaattijärjestelmän tason ominaisuuksista.
...
![](images/clipboard-1771973092.png)QGISin **Tasot**-paneeliin ilmestyy uudelleenprojisoitu paikkatietoaineisto. Voit tarkistaa koordinaattijärjestelmän tason ominaisuuksista.
...
```{=html}
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfZAwYbvYGGgWzlRuZ45HcNYfpcVUTJYENL4PGeulqAi_6Nfg/viewform?embedded=true" width="700" height="600" frameborder="0" marginheight="0" marginwidth="0"></iframe>
```
