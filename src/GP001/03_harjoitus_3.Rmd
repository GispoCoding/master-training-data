...
![](images/clipboard-1356610124.png)Valitse saatavilla olevista aineistoista **Ajantasa_asemakaava_maanpaallinen_varillinen**. Voit vaihtaa QGIS-projektiin lisättävän tason nimen haluamaksesi kohdassa Tason nimi. Paina lopuksi **Lisää**, niin QGIS lisää tason projektiisi.

![](images/clipboard-32255326.png)Huomaa, että voit joutua odottamaan hetken, kun karttatasoa ladataan palvelimelta. Voit nyt sulkea **Tietolähteiden hallinta** -ikkunan ja palata karttaikkunaan. Karttaikkunassasi pitäisi nyt näkyä Helsingin kaupungin värillinen asemakaava-aineisto rasteritasona.
