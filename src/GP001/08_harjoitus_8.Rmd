...
QGISin automaattisesti luoma fid-kenttä antaa jokaiselle digitoitavalle kohteelle oman uniikin tunnisteen. Digitoijan ei tule kajota tähän kenttään lainkaan, joten estetään sen muokkaus. Mene **Tason ominaisuudet** -ikkunassa **Attribuuttilomake-välilehdelle** ja valitse **Tietokentät-listasta** fid. Mene oikealle puolelle **Yleistä**-kohtaan ja poista valinta kohdasta **Muokattava**. Nyt kyseistä kenttää ei voi vahingossakaan muokata.
