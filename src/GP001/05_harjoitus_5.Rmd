...
-   **..kurssihakemisto/Harjoitus 5/L4133B.asc**

-   **..kurssihakemisto/Harjoitus 5/TieViiva.gpkg**

-   **..kurssihakemisto/Harjoitus 5/ne_10m_populated_places_suomi.gpkg**

-   **..kurssihakemisto/Harjoitus 5/natura2000sac_alueet.gpkg**
...
![](images/clipboard-2815177279.png)Avaa tason **Kuvaustekniikka-asetukset**. Muista, että rasteriaineistojen kuvaustekniikkatyökalut ovat erilaiset kuin vektoriaineistoilla. Voit vaihtaa harmaasävyesityksen **pseudoväreiksi**. Voit kokeilla myös **rinnevarjostetta**.
...
![](images/clipboard-2975752488.png)
