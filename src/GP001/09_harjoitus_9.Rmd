...
Määrittele syötetasoksi NaturaKohde ja leikkaavaksi tasoksi HallintoAlue-aineisto. Aineistossa voi olla geometriavirheitä, joten suodatetaan ne pois analyysista. Paina syötetason vierestä Asetukset ![](img/harjoitus_9/image23.png) ja valitse **Invalid feature filtering** asetukseksi "Skip (Ignore) features with invalid geometries. Näin analyysi ei lopu, vaikka aineistossa on virheellisiä kohteita.
...
Valitse syötetasoksi aiemmin tehty Ristiinleikkaus-taso ja valitse sulautuksen perusteena oleva sarake painamalla Dissolve fields kohdasta ![](img/harjoitus_9/image21.png).
