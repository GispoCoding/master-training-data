...
Määrittele syötetasoksi natura2000sac_alueet ja leikkaavaksi tasoksi kunnat2024-aineisto. Aineistossa voi olla geometriavirheitä, joten suodatetaan ne pois analyysista. Paina syötetason vierestä Asetukset ![](img/harjoitus_9/image5.png) ja valitse **Invalid feature filtering** asetukseksi "Skip (Ignore) features with invalid geometries. Näin analyysi ei lopu, vaikka aineistossa on virheellisiä kohteita.
