...
**HTML- ja CSS-koodit, SQL-komennot sekä Python-scriptit** on esitetty
seuraavasti:
...
Jos havaitset materiaalissa virheitä, niin pyydämme
ilmoittamaan niistä kouluttajalle tai sähköpostilla
[info\@gispo.fi-osoitteeseen](mailto:info@gispo.fi-osoitteeseen){.email}.

## Lisenssi ja oikeudet

Nämä materiaalit on "license_title_replace"- kurssille kehittänyt Gispo
Suomi Oy. Materiaalit on lisensoitu seuraavalla lisenssillä: [CC BY-ND
