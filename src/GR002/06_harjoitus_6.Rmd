...
![](img/harjoitus_6/image2.png){width="331"}
...
Luodaan seuraavaksi yhteys WFS (Web Feature Service)-paikkatietopalveluun, jonka kautta QGIS-projektiin saadaan lisättyä erilaisia vektoriaineistoja. WFS-palveluihin yhdistäminen tapahtuu muuten samalla tavalla kuin WMS-palveluihin yhdistäminen, mutta WMS/WMTS-välilehden sijaan on valittava WFS-välilehti. Avaa siis jälleen **Tietolähteiden hallinta \> WFS-välilehti** tai klikkaa suoraan **Tasojen hallinnan työkalupalkista** löytyvää **Lisää WFS-taso** -painiketta ![](img/harjoitus_6/image7.png).
