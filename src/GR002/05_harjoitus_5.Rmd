...
Kun olet digitoinut 5–8 uutta kohdetta poistu muokkaustilasta painamalla uudelleen lyijykynä-työkalua. Tallenna muutokset ja määrittele kuvaustekniikka polygoneille. Pääset muuttamaaan kuvaustekniikkaa avaamalla **Tason ominaisuudet- valikon** ja valitsemalla siellä välilehden **Kuvaustekniikka** Alempana on esimerkkikuva digitoiduista alueilta, mutta voit valita vapaasti digitoitavat kohteesi: 
